              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Real-time monitoring with automatic refresh. Track user
                    activity, tool usage, regional engagement, and system
                    health. Data is stored locally and persists across sessions.
                  </p>
                </div>
              </div>
            </div>
